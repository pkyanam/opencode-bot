...
const commit = args.get("--commit"), digest = args.get("--digest"), version = args.get("--version"), reference = args.get("--reference");
...
const manifest = { schemaVersion: 2, version, commit, opencodeVersion: "2.0.11", sandboxVersion: "0.12.9", platform: "linux/amd64", image: { reference }, buildImageDigest: digest };
if (args.get("--bundle")) {
